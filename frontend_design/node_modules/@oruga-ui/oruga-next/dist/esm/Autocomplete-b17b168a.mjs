import { defineComponent, resolveComponent, openBlock, createElementBlock, normalizeClass, createVNode, mergeProps, withKeys, withModifiers, Transition, withCtx, withDirectives, createBlock, resolveDynamicComponent, normalizeStyle, renderSlot, createCommentVNode, Fragment, renderList, toDisplayString, vShow } from 'vue';
import { s as script$1 } from './Input-563330cf.mjs';
      ...
      default: withCtx(() => [_ctx.$slots.header ? (openBlock(), createBlock(resolveDynamicComponent(_ctx.itemTag), {
        ...
        return openBlock(), createElementBlock(Fragment, null, [element.group ? (openBlock(), createBlock(resolveDynamicComponent(_ctx.itemTag), {
          ...
          default: withCtx(() => [_ctx.$slots.group ? renderSlot(_ctx.$slots, "group", {
            ...
            group: element.group,
            index: groupindex
          }) : (openBlock(), createElementBlock("span", _hoisted_1, toDisplayString(element.group), 1 /* TEXT */))]),
          ...
          return openBlock(), createBlock(resolveDynamicComponent(_ctx.itemTag), {
            ...
            default: withCtx(() => [_ctx.$slots.default ? renderSlot(_ctx.$slots, "default", {
              ...
              option: option,
              index: index
            }) : (openBlock(), createElementBlock("span", _hoisted_2, toDisplayString(_ctx.getValue(option)), 1 /* TEXT */))]),
