import { defineComponent, resolveComponent, openBlock, createElementBlock, normalizeClass, withDirectives, mergeProps, vModelDynamic, vModelText, createBlock, createCommentVNode, toDisplayString } from 'vue';
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }), null, 16 /* FULL_PROPS */, _hoisted_1)), [[vModelDynamic, _ctx.computedValue]]) : withDirectives((openBlock(), createElementBlock("textarea", mergeProps({
    key: 1
  }, _ctx.$attrs, {
    ref: "textarea",
    class: _ctx.inputClasses,
  ...
  }), null, 16 /* FULL_PROPS */, _hoisted_2)), [[vModelText, _ctx.computedValue]]), _ctx.icon ? (openBlock(), createBlock(_component_o_icon, {
    key: 2,
