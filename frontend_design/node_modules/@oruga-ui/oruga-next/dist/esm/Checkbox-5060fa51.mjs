import { defineComponent, openBlock, createElementBlock, normalizeClass, withModifiers, withKeys, withDirectives, createElementVNode, mergeProps, vModelCheckbox, renderSlot, createTextVNode, toDisplayString, createCommentVNode } from 'vue';
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }), null, 16 /* FULL_PROPS */, _hoisted_1), [[vModelCheckbox, _ctx.computedValue]]), _ctx.label || _ctx.$slots.default ? (openBlock(), createElementBlock("span", {
    key: 0,
    id: _ctx.ariaLabelledby,
    class: normalizeClass(_ctx.labelClasses)
  }, [renderSlot(_ctx.$slots, "default", {}, () => [createTextVNode(toDisplayString(_ctx.label), 1 /* TEXT */)])], 10 /* CLASS, PROPS */, _hoisted_2)) : createCommentVNode("v-if", true)], 34 /* CLASS, HYDRATE_EVENTS */);
}
