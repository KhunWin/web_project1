import { defineComponent, resolveDirective, openBlock, createElementBlock, normalizeClass, withModifiers, renderSlot, createTextVNode, toDisplayString, createCommentVNode, createVNode, Transition, withCtx, withDirectives, vShow, createBlock, resolveDynamicComponent, normalizeStyle } from 'vue';
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, () => [createTextVNode(toDisplayString(_ctx.label), 1 /* TEXT */)])], 42 /* CLASS, PROPS, HYDRATE_EVENTS */, _hoisted_1)) : createCommentVNode("v-if", true), createVNode(Transition, {
    name: _ctx.animation
  }, {
